...
namespace Weebree.VsEventLog_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        public void ValidateToolWindowShown()
        {
            ...
            MethodInfo method = typeof(VsEventLogPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
