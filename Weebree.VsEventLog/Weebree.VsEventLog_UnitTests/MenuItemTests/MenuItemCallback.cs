...
using Weebree.VsEventLog;

namespace Weebree.VsEventLog_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VsEventLogPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Weebree.VsEventLog.GuidList.guidWeebree_VsEventLogCmdSet, (int)Weebree.VsEventLog.PkgCmdIDList.cmdidWeebreeVsEventLogCommand);
