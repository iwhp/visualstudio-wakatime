...
namespace Weebree.VsEventLog_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Weebree.VsEventLog.GuidList.guidWeebree_VsEventLogCmdSet, (int)Weebree.VsEventLog.PkgCmdIDList.cmdidWeebreeVsEventLogCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Weebree.VsEventLog", "Weebree.VsEventLog.Weebree_VsEventLogPackage");
